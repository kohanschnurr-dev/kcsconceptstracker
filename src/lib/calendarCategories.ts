...
export const CATEGORY_GROUPS: Record<CategoryGroup, { label: string; color: string; bgClass: string; textClass: string; borderClass: string }> = {
  acquisition_admin: {
    ...
    textClass: 'text-foreground dark:text-blue-400',
  ...
  structural_exterior: {
    ...
    textClass: 'text-foreground dark:text-red-400',
  ...
  rough_ins: {
    ...
    textClass: 'text-foreground dark:text-orange-400',
  ...
  inspections: {
    ...
    textClass: 'text-foreground dark:text-purple-400',
  ...
  interior_finishes: {
    ...
    textClass: 'text-foreground dark:text-emerald-400',
  ...
  milestones: {
    ...
    textClass: 'text-foreground dark:text-amber-400',
