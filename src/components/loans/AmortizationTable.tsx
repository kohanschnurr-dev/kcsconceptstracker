...
export function AmortizationTable({ loan, extensionMonths = 0, finalDate }: AmortizationTableProps) {
  const schedule = useMemo(() => buildAmortizationSchedule(loan, extensionMonths, finalDate), [loan, extensionMonths, finalDate]);
