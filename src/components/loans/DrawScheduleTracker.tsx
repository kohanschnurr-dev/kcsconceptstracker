...
import { DRAW_STATUS_CONFIG } from '@/types/loans';
import type { LoanDraw, DrawStatus } from '@/types/loans';
...
export function DrawScheduleTracker({
  draws, totalDrawAmount, onUpsert, onDelete, loanId, readOnly = false,
